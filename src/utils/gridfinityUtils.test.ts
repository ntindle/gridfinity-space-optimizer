  ...
  describe('combineHalfSizeBins', () => {
    it('should combine half-size bins into larger groups', () => {
      const halfSizeBins: LayoutItem[] = [
        { pixelX: 0, pixelY: 0, pixelWidth: 21, pixelHeight: 21, x: 0, y: 0, width: 0.5, height: 0.5, type: 'half-size' },
        { pixelX: 21, pixelY: 0, pixelWidth: 21, pixelHeight: 21, x: 0.5, y: 0, width: 0.5, height: 0.5, type: 'half-size' },
        { pixelX: 0, pixelY: 21, pixelWidth: 21, pixelHeight: 21, x: 0, y: 0.5, width: 0.5, height: 0.5, type: 'half-size' },
        { pixelX: 21, pixelY: 21, pixelWidth: 21, pixelHeight: 21, x: 0.5, y: 0.5, width: 0.5, height: 0.5, type: 'half-size' },
      ]
